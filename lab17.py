...
def delete(root, key):
    ...
    if key < root.data:  # Если ключ меньше текущего узла, ищем в левом поддереве
        ...
        root.right = delete(root.right, temp.data)  # Удаляем минимальный узел из правого поддерева
...
def main():
    ...
    while True:
        ...
        if choice == '1':  # Добавление вершины
            value = int(input("Введите значение для добавления: "))  # Запрашиваем значение
            ...
            print("Некорректный ввод. Попробуйте снова.")  # Если пользователь ввел некорректный номер операции
